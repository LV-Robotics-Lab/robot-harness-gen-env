...
usd_path = source_repo / "assets/objects/hope/corn_can.usd"
texture_path = source_repo / "assets/objects/hope/textures/obj_000007.png"
license_path = source_repo / "assets/objects/hope/LICENSE"

out_dir = (
    project_root
    / "onboarding-report/artifacts/robolab_migration"
    / "901_robolab_corn_can"
)
...
mesh = UsdGeom.Mesh.Get(stage, "/corn_can/obj_000007_Mesh")
if not mesh:
    raise RuntimeError("Corn-can mesh was not found")
...
- Source file: assets/objects/hope/corn_can.usd
- Source texture: assets/objects/hope/textures/obj_000007.png
