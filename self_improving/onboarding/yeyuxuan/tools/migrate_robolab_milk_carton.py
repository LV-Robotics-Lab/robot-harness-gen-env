...
usd_path = source_repo / "assets/objects/hope/milk_carton.usd"
texture_path = source_repo / "assets/objects/hope/textures/obj_000014.png"
license_path = source_repo / "assets/objects/hope/LICENSE"

out_dir = (
    project_root
    / "onboarding-report/artifacts/robolab_migration"
    / "902_robolab_milk_carton"
)
...
mesh = UsdGeom.Mesh.Get(stage, "/milk_carton/obj_000014_Mesh")
if not mesh:
    raise RuntimeError("Milk-carton mesh was not found")
...
- Asset: HOPE milk carton
- Source repository: https://github.com/NVLabs/RoboLab
- Source commit: {commit}
- Source file: assets/objects/hope/milk_carton.usd
- Source texture: assets/objects/hope/textures/obj_000014.png
