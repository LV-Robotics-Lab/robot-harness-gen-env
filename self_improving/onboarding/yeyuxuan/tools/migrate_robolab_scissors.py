...
usd_path = source_repo / "assets/objects/ycb/scissors.usd"
texture_path = source_repo / "assets/objects/ycb/textures/obj_000017.png"
license_path = source_repo / "assets/objects/ycb/LICENSE"

out_dir = (
    project_root
    / "onboarding-report/artifacts/robolab_migration"
    / "905_robolab_scissors"
)
...
mesh = UsdGeom.Mesh.Get(stage, "/scissors/obj_000017_Mesh")
if not mesh:
    raise RuntimeError("Scissors mesh was not found")
...
# A convex hull is sufficient and more stable for a rigid scissors collision model.
...
- Source file: assets/objects/ycb/scissors.usd
- Source texture: assets/objects/ycb/textures/obj_000017.png
- License: MIT
- Source physics: mass 0.2 kg, dynamic friction 2.0,
...
- Collision limitation: a single convex hull is used; handle openings are filled in the collision representation.
