...
- Source file: assets/objects/ycb/bowl.usd
- Source texture: assets/objects/ycb/textures/obj_000013.png
- License: MIT
...
- Collision limitation: A single convex hull is used; the bowl cavity is filled in the collision representation.
- Intended use: RoboTwin rigid-object placement and grasping validation; not suitable for containment interactions.
