...
| `schema_catalog.py`、`json_schemas/` | PR1 的 14 个公开 `$id` 加 descriptor v2，共 15 份可审阅 JSON Schema snapshot。 | `SCHEMA_MODELS`、`schema_documents`、`export_schema_snapshots` | `python script/export_harness_schemas.py --check`、`test_schema_catalog.py`；v1 snapshot 前后字节身份相同 |
