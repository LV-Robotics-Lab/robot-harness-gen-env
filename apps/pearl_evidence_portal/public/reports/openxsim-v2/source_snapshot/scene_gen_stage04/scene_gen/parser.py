...
UNSUPPORTED_FEATURE_PATTERNS = (
    (r"\b(?:inside|into|within|contains?)\b|里面|内部|放进|装进", "inside"),
    (r"\b(?:stack|stacked|on top of)\b|堆叠|叠在|顶部", "stacking"),
    (r"\b(?:drawer|door|joint|articulated|hinge)\b|抽屉|关节|铰链|开门", "articulation"),
